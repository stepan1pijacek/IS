    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "FEKT" });

            migrationBuilder.InsertData(
                table: "Students",
                columns: new[] { "Id", "DateOfBirth", "Email", "FacultyId", "Name", "Phone", "Surname", "Year" },
                values: new object[] { 1, new DateTime(2000, 1, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "golian@seznam.cz", 1, "Igor", 734220456, "Golian", 2021 });
